...
CREATE TABLE IF NOT EXISTS `familyhealth`.`tbl_appointment` (
  ...
  PRIMARY KEY (`id`, `patientuserid`, `doctoruserid`),
...
INSERT INTO tbl_user (username, password, email, profileid) VALUES ('administrador', SHA1('administrador'), 'administrador@familyhealth.com',LAST_INSERT_ID());
...
INSERT INTO tbl_user (username, password, email, profileid) VALUES ('doctor1', SHA1('doctor1'), 'doctor1@familyhealth.com',LAST_INSERT_ID());
...
INSERT INTO tbl_user (username, password, email, profileid) VALUES ('doctor2', SHA1('doctor2'), 'doctor2@familyhealth.com',LAST_INSERT_ID());
INSERT INTO tbl_profile (firstname, lastname) VALUES ('paciente1 nombre', 'paciente1 apellido');
INSERT INTO tbl_user (username, password, email, profileid) VALUES ('paciente1', SHA1('paciente1'), 'paciente1@familyhealth.com',LAST_INSERT_ID());
INSERT INTO tbl_profile (firstname, lastname) VALUES ('paciente2 nombre', 'paciente2 apellido');
INSERT INTO tbl_user (username, password, email, profileid) VALUES ('paciente2', SHA1('paciente2'), 'paciente2@familyhealth.com',LAST_INSERT_ID());
INSERT INTO tbl_profile (firstname, lastname) VALUES ('paciente3 nombre', 'paciente3 apellido');
INSERT INTO tbl_user (username, password, email, profileid) VALUES ('paciente3', SHA1('paciente3'), 'paciente3@familyhealth.com',LAST_INSERT_ID());
